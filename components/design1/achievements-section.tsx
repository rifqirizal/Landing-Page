...
export default function AchievementsSection() {
  ...
  return (
    <section className="py-20 bg-[#222222] dark:bg-black text-white">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          ref={ref}
        >
          <span className="text-[#BD1010] text-lg font-medium uppercase tracking-wider">Our Impact</span>
          <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-6">Our Achievements in Numbers</h2>
        ...
        >
          {achievements.map((achievement, index) => (
            <motion.div
              ...
              className="bg-[#333333] dark:bg-[#222222] p-8 text-center transform transition-transform hover:scale-105 hover:bg-[#444444] dark:hover:bg-[#333333] rounded-3xl"
