...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-20 bg-[#F0F0F0] dark:bg-[#111111]">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <motion.h2
            ...
            className="text-3xl md:text-4xl font-bold text-[#222222] dark:text-white mb-6"
            ref={ref}
          >
            Our Services
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-lg text-[#585858] dark:text-[#AAAAAA]"
          >
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#222222] p-8 shadow-lg hover:shadow-xl transition-shadow rounded-3xl"
            >
              <div className="bg-[#F0F0F0] dark:bg-[#333333] p-4 inline-block mb-6 rounded-2xl">{service.icon}</div>
