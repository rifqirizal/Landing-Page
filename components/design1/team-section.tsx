...
export default function TeamSection() {
  ...
  return (
    <section className="py-20 bg-white dark:bg-[#222222]">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          ref={ref}
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#222222] dark:text-white mb-6">Meet Our Team</h2>
        ...
        >
          {team.map((member, index) => (
            <motion.div
              ...
              className="bg-[#F0F0F0] dark:bg-[#111111] overflow-hidden group rounded-3xl"
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#222222] dark:text-white">{member.name}</h3>
                <p className="text-[#585858] dark:text-[#AAAAAA]">{member.position}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
